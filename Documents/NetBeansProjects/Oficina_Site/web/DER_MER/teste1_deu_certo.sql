create function inserir_controla_auditoria2() returns trigger as $$
...
create trigger trigger_inserir_controla_auditoria2
after insert on Controla
for each row
execute procedure inserir_controla_auditoria2();
